...
- **Frontend:** http://localhost               -- merge
- **Backend API:** http://localhost:5000       --NU MERGE
- **Swagger:** http://localhost:5000/swagger   --NU MERGE
- **HealthCheck** http://localhost:5000/health -- merge
- **Database:** localhost:5432                 -- merge
...
│       └── services/     # API calls
└── docs/                 # Documentație -----------echipă Urmeaza sa o pun
```
